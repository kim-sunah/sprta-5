...
import { collection, setDoc,updateDoc } from "https://www.gstatic.com/firebasejs/9.22.0/firebase-firestore.js";
...
$("#postingbtn").click(async function () {
    ...
    let password = prompt("게시글의 수정을 위해 비밀번호를 입력해주세요");
    ...
    console.log(doc);
    await setDoc(collection(db, "comment"), doc);
    alert('저장 완료!');
